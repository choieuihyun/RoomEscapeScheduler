...
전환을 미룬 이유였던 "빠진 기능"과 "리디자인 전"은 이제 둘 다 없다.
**Pages Source 전환은 여전히 사용자 승인이 필요하다** — 실제로 눌러
실서비스를 바꾸는 조작이라서.
...
기능·리디자인 둘 다 없는 게 없다 — 남은 건 배포 전환(Pages Source)
승인뿐이다. index.html의 §4.31~4.34에서 범위 밖으로 미뤘던 다섯 기능
